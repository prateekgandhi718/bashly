...
const BashSearch = ({
  ...
  const onClick = ({ id, type }: { id: string, type: "channel" | "member"}) => {
    ...
    if (type === "member") {
      return router.push(`/bashes/${params?.bashId}/conversations/${id}`)
    }

    if (type === "channel") {
      return router.push(`/bashes/${params?.bashId}/channels/${id}`)
    }
  }
